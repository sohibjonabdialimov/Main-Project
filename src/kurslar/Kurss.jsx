...
function Kurss() {
  ...
  let a=[
    {
      ...
      aboutCource: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever more",
      priceCourse: 125000,
      bought: 1950,
      davomiyligi: "3 oy",
      autorId:14,
    ...
    ,{
      ...
      aboutCource: "Lorem Ipsum is simply dummy text of the printing and typesetting",
      priceCourse: 0,
      bought: 10256,
      davomiyligi: "1 oy",
      autorId:14,
    ...
    },
    {
      ...
      author: "Cambridge LC",
      aboutCource: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since.",
      priceCourse: 100000,
      bought: 4256,
      davomiyligi: "3 oy",
      avatar: teacher3,
  ...
  let img, name, autorId, commints, author, bought, aboutCource, priceCourse, davomiyligi, avatar;
  ...
  for(let i=0;i<a.length;i++){
    if(a[i].kursId==kursId){
      ...
      priceCourse=a[i].priceCourse.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ' ')
