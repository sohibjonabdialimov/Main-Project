    ...
    <div className="ionex_hero justi">
      <div className="hero_logo1">
        <img
          ...
          width={320}
          id="aboutIlmlar"
          className="ionex-btn order-1"
          alt=""
        />
      </div>

      <div className="d-flex flex-wrap">
        <div className="col-lg-3 col-md-6 footer_list">
        ...
        <div className="col-lg-6 col-md-6 col-12 footer_list">
        ...
        <div className="col-lg-3 col-md-12 col-12 footer_list">
        ...
        <div className="mt-5">
          <p className="footer_p">
            ...
            yangi avlod ta'lim platformasi. {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </div>
